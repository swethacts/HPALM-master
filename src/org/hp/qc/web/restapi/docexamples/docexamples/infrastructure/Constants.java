...
public class Constants {
	...
	public static final String HOST = "ctsintbmvhpalm";
	public static final String PORT = "8080";

	public static final String USERNAME = "312356";
	public static final String PASSWORD = "k";

	public static final String DOMAIN = "DEFAULT";
	public static final String PROJECT = "Training";
